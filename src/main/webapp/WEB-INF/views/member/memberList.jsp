 ...
 <table class="table">
	...
	<thead>
	    <tr class ="bg_a" style="border-top:3px solid #000;">
			...
			<th class="bg_a2">아이디</th>
			<th class="bg_a3">이름</th>
			<th class="bg_a4">등록일</th>
			<th class="bg_a5">관리</th>
	    </tr>
    </thead>
    <tbody>
    	<c:forEach var ="item" items="${list}" varStatus="status">	
    		<tr id= "bid" >	   	
				...
				<th class="bg_ct">${item.mem_id}</th>
				<th class="bg_ct">${item.mem_nm}</th>
				<th class="bg_ct">${item.reg_dt}</th>
				<th class="bg_ct">
					<input type="button" onclick="upda();" value="수정">
